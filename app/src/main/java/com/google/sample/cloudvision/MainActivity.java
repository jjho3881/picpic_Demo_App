...
public class MainActivity extends AppCompatActivity {
    private static final String CLOUD_VISION_API_KEY = "AIzaSyDEaNCl9vCelPnvtW1wrRGlGBUhrAMhtAU";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btUploadtxt = (Button) findViewById(R.id.bt_upload_txt);
        ...
        ivPreview = (ImageView) findViewById(R.id.main_image);
        ...
        btUploadtxt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String str = mImageDetails.getText().toString().trim();
    ...
    private void uploadFile() {
        ...
        if (filePath != null) {
            ...
            StorageReference storageRef = storage.getReferenceFromUrl("gs://picpicsource.appspot.com").child("images/"+filename);
            //올라가거라...
